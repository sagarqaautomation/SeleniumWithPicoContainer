...
//			js.executeScript("window.scrollBy(0,document.body.scrollHeight");
	...
	public static String getDyanmicTestData(String key) throws IOException {
		Properties prop = new Properties();
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + filePath2);
		prop.load(fis);
		return prop.getProperty(key);
	}
	...
	public static void setGlobalValue(String key, String data) throws IOException {
		...
		File file = new File(System.getProperty("user.dir") + filePath2);
	...
	public static String readFile(String filePath) throws IOException {
		...
		Path absolutefilePath = Paths.get(projectFolderPath + apiFilePath + filePath);
